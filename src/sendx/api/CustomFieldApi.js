...
/**
* CustomField service.
* @module sendx/api/CustomFieldApi
* @version 1.0.0
*/
export default class CustomFieldApi {
    ...
    * @alias module:sendx/api/CustomFieldApi
    * @class
    ...
    */
     ...
     * @param {module:sendx/model/RestECustomField} restECustomField 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRCustomField} and HTTP response
     */
    createCustomFieldWithHttpInfo(restECustomField) {
      let postBody = restECustomField;
      // verify the required parameter 'restECustomField' is set
      if (restECustomField === undefined || restECustomField === null) {
        throw new Error("Missing the required parameter 'restECustomField' when calling createCustomField");
      }
      ...
      let returnType = RestRCustomField;
     ...
     * Creates a new custom field for storing contact data. 
     * @param {module:sendx/model/RestECustomField} restECustomField 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRCustomField}
     */
    createCustomField(restECustomField) {
      return this.createCustomFieldWithHttpInfo(restECustomField)
     ...
     * @param {String} identifier Custom field identifier to update
     ...
     */
    deleteCustomFieldWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling deleteCustomField");
      }
     ...
     */
    deleteCustomField(identifier) {
      return this.deleteCustomFieldWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} [offset = 0)] Number of fields to skip for pagination
     * @param {Number} [limit = 10)] Maximum number of fields to return
     * @param {String} [search] Search custom fields by name (case-insensitive partial matching).  **Examples:** - `points` - Finds \"Loyalty points\", \"Reward points\" 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendx/model/RestRCustomField>} and HTTP response
     */
    getAllCustomFieldsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * Retrieves all custom fields defined for your team. 
     * @param {Object} opts Optional parameters
     * @param {Number} opts.offset Number of fields to skip for pagination (default to 0)
     * @param {Number} opts.limit Maximum number of fields to return (default to 10)
     * @param {String} opts.search Search custom fields by name (case-insensitive partial matching).  **Examples:** - `points` - Finds \"Loyalty points\", \"Reward points\" 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendx/model/RestRCustomField>}
     */
    getAllCustomFields(opts) {
      return this.getAllCustomFieldsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRCustomField} and HTTP response
     */
    getCustomFieldWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getCustomField");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRCustomField}
     */
    getCustomField(identifier) {
      return this.getCustomFieldWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRCustomField} and HTTP response
     */
    updateCustomFieldWithHttpInfo(restECustomField, identifier) {
      let postBody = restECustomField;
      // verify the required parameter 'restECustomField' is set
      if (restECustomField === undefined || restECustomField === null) {
        throw new Error("Missing the required parameter 'restECustomField' when calling updateCustomField");
      }
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling updateCustomField");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRCustomField}
     */
    updateCustomField(restECustomField, identifier) {
      return this.updateCustomFieldWithHttpInfo(restECustomField, identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
