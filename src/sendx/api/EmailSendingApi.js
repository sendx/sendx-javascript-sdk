...
* @module sendx/api/EmailSendingApi
* @version 1.0.0
*/
export default class EmailSendingApi {

    /**
    * Constructs a new EmailSendingApi. 
    * @alias module:sendx/api/EmailSendingApi
    * @class
    ...
    */
     ...
     * @param {module:sendx/model/XEmailMessage} xEmailMessage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendx/model/XEmailResponse>} and HTTP response
     */
    sendEmailWithHttpInfo(xEmailMessage) {
      let postBody = xEmailMessage;
      // verify the required parameter 'xEmailMessage' is set
      if (xEmailMessage === undefined || xEmailMessage === null) {
        throw new Error("Missing the required parameter 'xEmailMessage' when calling sendEmail");
      }
     ...
     * Sends transactional emails to specified recipients with support for personalization, attachments, and tracking. 
     * @param {module:sendx/model/XEmailMessage} xEmailMessage 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendx/model/XEmailResponse>}
     */
    sendEmail(xEmailMessage) {
      return this.sendEmailWithHttpInfo(xEmailMessage)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendx/model/XEmailResponse>} and HTTP response
     */
    sendEmailWithTemplateWithHttpInfo(xEmailMessage) {
      let postBody = xEmailMessage;
      // verify the required parameter 'xEmailMessage' is set
      if (xEmailMessage === undefined || xEmailMessage === null) {
        throw new Error("Missing the required parameter 'xEmailMessage' when calling sendEmailWithTemplate");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendx/model/XEmailResponse>}
     */
    sendEmailWithTemplate(xEmailMessage) {
      return this.sendEmailWithTemplateWithHttpInfo(xEmailMessage)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
