...
export default class EventsApi {
    ...
    * @alias module:sendx/api/EventsApi
    * @class
    ...
    */
     ...
     */
    trackCustomEventWithHttpInfo(customEventRequest) {
      ...
      if (customEventRequest === undefined || customEventRequest === null) {
        throw new Error("Missing the required parameter 'customEventRequest' when calling trackCustomEvent");
      }
     ...
     */
    trackCustomEvent(customEventRequest) {
      return this.trackCustomEventWithHttpInfo(customEventRequest)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/EventResponse} and HTTP response
     */
    trackRevenueEventWithHttpInfo(revenueEventRequest) {
      ...
      if (revenueEventRequest === undefined || revenueEventRequest === null) {
        throw new Error("Missing the required parameter 'revenueEventRequest' when calling trackRevenueEvent");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/EventResponse}
     */
    trackRevenueEvent(revenueEventRequest) {
      return this.trackRevenueEventWithHttpInfo(revenueEventRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
