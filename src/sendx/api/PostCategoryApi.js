...
* @module sendx/api/PostCategoryApi
* @version 1.0.0
*/
export default class PostCategoryApi {

    /**
    * Constructs a new PostCategoryApi. 
    * @alias module:sendx/api/PostCategoryApi
    * @class
    ...
    */
     ...
     * @param {module:sendx/model/RestEPostCategory} restEPostCategory 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRPostCategory} and HTTP response
     */
    createPostCategoryWithHttpInfo(restEPostCategory) {
      let postBody = restEPostCategory;
      // verify the required parameter 'restEPostCategory' is set
      if (restEPostCategory === undefined || restEPostCategory === null) {
        throw new Error("Missing the required parameter 'restEPostCategory' when calling createPostCategory");
      }
      ...
      let returnType = RestRPostCategory;
     ...
     * Creates a new category for organizing blog posts. 
     * @param {module:sendx/model/RestEPostCategory} restEPostCategory 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRPostCategory}
     */
    createPostCategory(restEPostCategory) {
      return this.createPostCategoryWithHttpInfo(restEPostCategory)
     ...
     * @param {String} identifier The unique post category identifier to retrieve. - `post_category_YzS1wOU20yw87UUHKxMzwn` 
     ...
     */
    deletePostCategoryWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling deletePostCategory");
      }
      ...
      return this.apiClient.callApi(
        '/post/category/{identifier}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    deletePostCategory(identifier) {
      return this.deletePostCategoryWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendx/model/RestRPostCategory>} and HTTP response
     */
    getAllPostCategoriesWithHttpInfo() {
      let postBody = null;
     ...
     * Get all post categories
     * Retrieves all blog post categories. 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendx/model/RestRPostCategory>}
     */
    getAllPostCategories() {
      return this.getAllPostCategoriesWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRPostCategory} and HTTP response
     */
    getPostCategoryWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getPostCategory");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRPostCategory}
     */
    getPostCategory(identifier) {
      return this.getPostCategoryWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRPostCategory} and HTTP response
     */
    updatePostCategoryWithHttpInfo(restEPostCategory, identifier) {
      let postBody = restEPostCategory;
      // verify the required parameter 'restEPostCategory' is set
      if (restEPostCategory === undefined || restEPostCategory === null) {
        throw new Error("Missing the required parameter 'restEPostCategory' when calling updatePostCategory");
      }
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling updatePostCategory");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRPostCategory}
     */
    updatePostCategory(restEPostCategory, identifier) {
      return this.updatePostCategoryWithHttpInfo(restEPostCategory, identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
