...
export default class ReportApi {
    ...
    * @alias module:sendx/api/ReportApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestReportData} and HTTP response
     */
    getCampaignReportWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getCampaignReport");
      }
      ...
      let returnType = RestReportData;
      return this.apiClient.callApi(
        '/report/campaign/{identifier}', 'GET',
     ...
     * Retrieves a detailed performance report for a specific campaign. 
     * @param {String} identifier Resource identifier with prefix (e.g., `contact_BnKjkbBBS500CoBCP0oChQ`)  **Format:** `<prefix>_<22-character-id>` 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestReportData}
     */
    getCampaignReport(identifier) {
      return this.getCampaignReportWithHttpInfo(identifier)
