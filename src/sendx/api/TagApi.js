...
export default class TagApi {
    ...
    */
     ...
     * @param {module:sendx/model/RestETag} restETag 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRTag} and HTTP response
     */
    createTagWithHttpInfo(restETag) {
      let postBody = restETag;
      // verify the required parameter 'restETag' is set
      if (restETag === undefined || restETag === null) {
        throw new Error("Missing the required parameter 'restETag' when calling createTag");
      }
     ...
     * Creates a new tag for contact categorization. 
     * @param {module:sendx/model/RestETag} restETag 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRTag}
     */
    createTag(restETag) {
      return this.createTagWithHttpInfo(restETag)
     ...
     * @param {String} identifier Tag identifier to update
     ...
     */
    deleteTagWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling deleteTag");
      }
    ...
    deleteTag(identifier) {
      return this.deleteTagWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} [offset = 0)] Number of tags to skip
     * @param {Number} [limit = 10)] Maximum number of tags to return
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendx/model/RestRTag>} and HTTP response
     */
     ...
     * Retrieves all tags in your team. 
     * @param {Object} opts Optional parameters
     * @param {Number} opts.offset Number of tags to skip (default to 0)
     * @param {Number} opts.limit Maximum number of tags to return (default to 10)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendx/model/RestRTag>}
     */
    getAllTags(opts) {
     ...
     * @param {String} identifier Tag identifier to retrieve
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRTag} and HTTP response
     */
    getTagWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getTag");
      }
     ...
     */
    getTag(identifier) {
      return this.getTagWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRTag} and HTTP response
     */
    updateTagWithHttpInfo(restETag, identifier) {
      let postBody = restETag;
      // verify the required parameter 'restETag' is set
      if (restETag === undefined || restETag === null) {
        throw new Error("Missing the required parameter 'restETag' when calling updateTag");
      }
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling updateTag");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRTag}
     */
    updateTag(restETag, identifier) {
      return this.updateTagWithHttpInfo(restETag, identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
