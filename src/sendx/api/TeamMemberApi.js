...
/**
* TeamMember service.
* @module sendx/api/TeamMemberApi
* @version 1.0.0
*/
export default class TeamMemberApi {
    ...
    * @alias module:sendx/api/TeamMemberApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:sendx/model/RestRMember>} and HTTP response
     */
    getAllTeamMembersWithHttpInfo() {
      let postBody = null;
     ...
     * Get all team members
     * Retrieves all team members.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:sendx/model/RestRMember>}
     */
    getAllTeamMembers() {
      return this.getAllTeamMembersWithHttpInfo()
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sendx/model/RestRMember} and HTTP response
     */
    getTeamMemberWithHttpInfo(identifier) {
      let postBody = null;
      // verify the required parameter 'identifier' is set
      if (identifier === undefined || identifier === null) {
        throw new Error("Missing the required parameter 'identifier' when calling getTeamMember");
      }
     ...
     * Retrieves a single team member by their unique identifier.
     * @param {String} identifier Resource identifier with prefix (e.g., `contact_BnKjkbBBS500CoBCP0oChQ`)  **Format:** `<prefix>_<22-character-id>` 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sendx/model/RestRMember}
     */
    getTeamMember(identifier) {
      return this.getTeamMemberWithHttpInfo(identifier)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
