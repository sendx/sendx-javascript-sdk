...
export default class TrackingApi {
    ...
    * @alias module:sendx/api/TrackingApi
    * @class
    ...
    */
     ...
     */
    trackContactWithHttpInfo(trackRequest) {
      let postBody = trackRequest;
      // verify the required parameter 'trackRequest' is set
      if (trackRequest === undefined || trackRequest === null) {
        throw new Error("Missing the required parameter 'trackRequest' when calling trackContact");
      }
     ...
     */
    trackContact(trackRequest) {
      return this.trackContactWithHttpInfo(trackRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
