...
class DeleteResponse {
     ...
     * @param status {module:sendx/model/DeleteResponse.StatusEnum} 
     * @param message {String} 
     */
    constructor(status, message) { 
        
        DeleteResponse.initialize(this, status, message);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of DeleteResponse.RequiredProperties) {
...
/**
     * @return {module:sendx/model/DeleteResponse.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:sendx/model/DeleteResponse.StatusEnum} status
     */
    setStatus(status) {
        this['status'] = status;
    }
...
DeleteResponse.RequiredProperties = ["status", "message"];

/**
 * @member {module:sendx/model/DeleteResponse.StatusEnum} status
 */
