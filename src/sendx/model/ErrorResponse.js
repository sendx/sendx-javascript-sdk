 ...
 * @module sendx/model/ErrorResponse
 * @version 1.0.0
 */
class ErrorResponse {
    /**
     * Constructs a new <code>ErrorResponse</code>.
     * @alias module:sendx/model/ErrorResponse
     * @param status {module:sendx/model/ErrorResponse.StatusEnum} 
     * @param message {String} Human-readable error message
     */
    constructor(status, message) { 
        
        ErrorResponse.initialize(this, status, message);
    }
     ...
     * @param {module:sendx/model/ErrorResponse} obj Optional instance to populate.
     * @return {module:sendx/model/ErrorResponse} The populated <code>ErrorResponse</code> instance.
     */
...
/**
     * @return {module:sendx/model/ErrorResponse.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:sendx/model/ErrorResponse.StatusEnum} status
     */
    setStatus(status) {
        this['status'] = status;
    }
...
ErrorResponse.RequiredProperties = ["status", "message"];

/**
 * @member {module:sendx/model/ErrorResponse.StatusEnum} status
 */
