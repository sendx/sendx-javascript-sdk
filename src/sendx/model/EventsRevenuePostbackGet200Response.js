...
/**
 * The EventsRevenuePostbackGet200Response model module.
 * @module sendx/model/EventsRevenuePostbackGet200Response
 * @version 1.0.0
 */
class EventsRevenuePostbackGet200Response {
    /**
     * Constructs a new <code>EventsRevenuePostbackGet200Response</code>.
     * @alias module:sendx/model/EventsRevenuePostbackGet200Response
     */
    constructor() { 
        
        EventsRevenuePostbackGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventsRevenuePostbackGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/EventsRevenuePostbackGet200Response} obj Optional instance to populate.
     * @return {module:sendx/model/EventsRevenuePostbackGet200Response} The populated <code>EventsRevenuePostbackGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsRevenuePostbackGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>EventsRevenuePostbackGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsRevenuePostbackGet200Response</code>.
     */
 ...
 */
EventsRevenuePostbackGet200Response.prototype['message'] = undefined;

/**
 * @member {String} status
 */
EventsRevenuePostbackGet200Response.prototype['status'] = undefined;
...
export default EventsRevenuePostbackGet200Response;
