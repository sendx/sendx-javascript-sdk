...
/**
 * The EventsRevenuePostbackGet400Response model module.
 * @module sendx/model/EventsRevenuePostbackGet400Response
 * @version 1.0.0
 */
class EventsRevenuePostbackGet400Response {
    /**
     * Constructs a new <code>EventsRevenuePostbackGet400Response</code>.
     * @alias module:sendx/model/EventsRevenuePostbackGet400Response
     */
    constructor() { 
        
        EventsRevenuePostbackGet400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventsRevenuePostbackGet400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/EventsRevenuePostbackGet400Response} obj Optional instance to populate.
     * @return {module:sendx/model/EventsRevenuePostbackGet400Response} The populated <code>EventsRevenuePostbackGet400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsRevenuePostbackGet400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>EventsRevenuePostbackGet400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsRevenuePostbackGet400Response</code>.
     */
 ...
 * @member {String} error
 */
EventsRevenuePostbackGet400Response.prototype['error'] = undefined;
...
export default EventsRevenuePostbackGet400Response;
