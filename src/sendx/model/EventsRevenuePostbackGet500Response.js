...
/**
 * The EventsRevenuePostbackGet500Response model module.
 * @module sendx/model/EventsRevenuePostbackGet500Response
 * @version 1.0.0
 */
class EventsRevenuePostbackGet500Response {
    /**
     * Constructs a new <code>EventsRevenuePostbackGet500Response</code>.
     * @alias module:sendx/model/EventsRevenuePostbackGet500Response
     */
    constructor() { 
        
        EventsRevenuePostbackGet500Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventsRevenuePostbackGet500Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/EventsRevenuePostbackGet500Response} obj Optional instance to populate.
     * @return {module:sendx/model/EventsRevenuePostbackGet500Response} The populated <code>EventsRevenuePostbackGet500Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsRevenuePostbackGet500Response();
    ...
    /**
     * Validates the JSON data with respect to <code>EventsRevenuePostbackGet500Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsRevenuePostbackGet500Response</code>.
     */
 ...
 * @member {String} error
 */
EventsRevenuePostbackGet500Response.prototype['error'] = undefined;
...
export default EventsRevenuePostbackGet500Response;
