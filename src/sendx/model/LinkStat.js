...
/**
 * The LinkStat model module.
 * @module sendx/model/LinkStat
 * @version 1.0.0
 */
class LinkStat {
    /**
     * Constructs a new <code>LinkStat</code>.
     * Link statistics
     * @alias module:sendx/model/LinkStat
     */
    constructor() { 
        
        LinkStat.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LinkStat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/LinkStat} obj Optional instance to populate.
     * @return {module:sendx/model/LinkStat} The populated <code>LinkStat</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinkStat();
    ...
    /**
     * Validates the JSON data with respect to <code>LinkStat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinkStat</code>.
     */
...
/**
    ...
    /**
     * Sets The link clicked
     * @param {String} url The link clicked
     */
    setUrl(url) {
        this['url'] = url;
    }
/**
     * Returns Total number of times the link was clicked
     * @return {Number}
     */
    getCount() {
        return this.count;
    ...
    /**
     * Sets Total number of times the link was clicked
     * @param {Number} count Total number of times the link was clicked
     */
    setCount(count) {
        this['count'] = count;
    }
 ...
 * @member {String} url
 */
LinkStat.prototype['url'] = undefined;

/**
 * Total number of times the link was clicked
 * @member {Number} count
 */
LinkStat.prototype['count'] = undefined;
