...
/**
 * The PostbackResponse model module.
 * @module sendx/model/PostbackResponse
 * @version 1.0.0
 */
class PostbackResponse {
    /**
     * Constructs a new <code>PostbackResponse</code>.
     * @alias module:sendx/model/PostbackResponse
     */
    constructor() { 
        
        PostbackResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostbackResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/PostbackResponse} obj Optional instance to populate.
     * @return {module:sendx/model/PostbackResponse} The populated <code>PostbackResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostbackResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PostbackResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostbackResponse</code>.
     */
 ...
 */
PostbackResponse.prototype['success'] = undefined;

/**
 * @member {String} message
 */
PostbackResponse.prototype['message'] = undefined;
...
export default PostbackResponse;
