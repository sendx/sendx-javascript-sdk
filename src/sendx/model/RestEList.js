...
/**
 * The RestEList model module.
 * @module sendx/model/RestEList
 * @version 1.0.0
 */
class RestEList {
    /**
     * Constructs a new <code>RestEList</code>.
     * @alias module:sendx/model/RestEList
     * @param name {String} List name
     */
    constructor(name) { 
        
        RestEList.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>RestEList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestEList} obj Optional instance to populate.
     * @return {module:sendx/model/RestEList} The populated <code>RestEList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestEList();
    ...
    /**
     * Validates the JSON data with respect to <code>RestEList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestEList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RestEList.RequiredProperties) {
...
RestEList.RequiredProperties = ["name"];

/**
 * List name
 * @member {String} name
 */
RestEList.prototype['name'] = undefined;
