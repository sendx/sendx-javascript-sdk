...
/**
 * The RestEPostCategory model module.
 * @module sendx/model/RestEPostCategory
 * @version 1.0.0
 */
class RestEPostCategory {
    /**
     * Constructs a new <code>RestEPostCategory</code>.
     * @alias module:sendx/model/RestEPostCategory
     * @param name {String} Category name
     */
    constructor(name) { 
        
        RestEPostCategory.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>RestEPostCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestEPostCategory} obj Optional instance to populate.
     * @return {module:sendx/model/RestEPostCategory} The populated <code>RestEPostCategory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestEPostCategory();
    ...
    /**
     * Validates the JSON data with respect to <code>RestEPostCategory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestEPostCategory</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RestEPostCategory.RequiredProperties) {
...
RestEPostCategory.RequiredProperties = ["name"];

/**
 * Category name
 * @member {String} name
 */
RestEPostCategory.prototype['name'] = undefined;
...
export default RestEPostCategory;
