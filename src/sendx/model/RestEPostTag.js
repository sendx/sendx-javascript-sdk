...
/**
 * The RestEPostTag model module.
 * @module sendx/model/RestEPostTag
 * @version 1.0.0
 */
class RestEPostTag {
    /**
     * Constructs a new <code>RestEPostTag</code>.
     * @alias module:sendx/model/RestEPostTag
     * @param name {String} Tag name
     */
    constructor(name) { 
        
        RestEPostTag.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>RestEPostTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestEPostTag} obj Optional instance to populate.
     * @return {module:sendx/model/RestEPostTag} The populated <code>RestEPostTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestEPostTag();
    ...
    /**
     * Validates the JSON data with respect to <code>RestEPostTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestEPostTag</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RestEPostTag.RequiredProperties) {
...
RestEPostTag.RequiredProperties = ["name"];

/**
 * Tag name
 * @member {String} name
 */
RestEPostTag.prototype['name'] = undefined;
