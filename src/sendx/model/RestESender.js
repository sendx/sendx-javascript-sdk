...
/**
 * The RestESender model module.
 * @module sendx/model/RestESender
 * @version 1.0.0
 */
class RestESender {
    /**
     * Constructs a new <code>RestESender</code>.
     * @alias module:sendx/model/RestESender
     * @param name {String} Sender display name
     * @param email {String} Sender email address (must be verified)
     */
    constructor(name, email) { 
        
        RestESender.initialize(this, name, email);
    }
    ...
    /**
     * Constructs a <code>RestESender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestESender} obj Optional instance to populate.
     * @return {module:sendx/model/RestESender} The populated <code>RestESender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestESender();
    ...
    /**
     * Validates the JSON data with respect to <code>RestESender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestESender</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RestESender.RequiredProperties) {
...
/**
     * Returns Sender email address (must be verified)
     * @return {String}
     */
    getEmail() {
        return this.email;
    ...
    /**
     * Sets Sender email address (must be verified)
...
RestESender.RequiredProperties = ["name", "email"];

/**
 * Sender display name
 * @member {String} name
 */
RestESender.prototype['name'] = undefined;

/**
 * Sender email address (must be verified)
 * @member {String} email
 */
RestESender.prototype['email'] = undefined;
