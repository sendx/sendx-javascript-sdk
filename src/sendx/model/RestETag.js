...
/**
 * The RestETag model module.
 * @module sendx/model/RestETag
 * @version 1.0.0
 */
class RestETag {
    /**
     * Constructs a new <code>RestETag</code>.
     * @alias module:sendx/model/RestETag
     * @param name {String} Tag name (must be unique within team)
     */
    constructor(name) { 
        
        RestETag.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>RestETag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestETag} obj Optional instance to populate.
     * @return {module:sendx/model/RestETag} The populated <code>RestETag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestETag();
    ...
    /**
     * Validates the JSON data with respect to <code>RestETag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestETag</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RestETag.RequiredProperties) {
...
/**
     * Returns Tag name (must be unique within team)
     * @return {String}
     */
    getName() {
        return this.name;
    ...
    /**
     * Sets Tag name (must be unique within team)
...
RestETag.RequiredProperties = ["name"];

/**
 * Tag name (must be unique within team)
 * @member {String} name
 */
RestETag.prototype['name'] = undefined;
