...
/**
 * The RestEWebhook model module.
 * @module sendx/model/RestEWebhook
 * @version 1.0.0
 */
class RestEWebhook {
    /**
     * Constructs a new <code>RestEWebhook</code>.
     * @alias module:sendx/model/RestEWebhook
     * @param url {String} Webhook endpoint URL
     * @param enabled {Boolean} Whether webhook is enabled
     */
    constructor(url, enabled) { 
        
        RestEWebhook.initialize(this, url, enabled);
    }
    ...
    /**
     * Constructs a <code>RestEWebhook</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestEWebhook} obj Optional instance to populate.
     * @return {module:sendx/model/RestEWebhook} The populated <code>RestEWebhook</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestEWebhook();
    ...
    /**
     * Validates the JSON data with respect to <code>RestEWebhook</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestEWebhook</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RestEWebhook.RequiredProperties) {
...
RestEWebhook.RequiredProperties = ["url", "enabled"];

/**
 * Webhook endpoint URL
 * @member {String} url
 */
RestEWebhook.prototype['url'] = undefined;
 ...
 * @default true
 */
RestEWebhook.prototype['enabled'] = true;
 ...
 * @default false
 */
RestEWebhook.prototype['unsubscribed'] = false;
 ...
 * @default false
 */
RestEWebhook.prototype['dropped'] = false;
 ...
 * @default false
 */
RestEWebhook.prototype['bounced'] = false;
 ...
 * @default false
 */
RestEWebhook.prototype['markedSpam'] = false;
 ...
 * @default false
 */
RestEWebhook.prototype['clicked'] = false;
 ...
 * @default false
 */
RestEWebhook.prototype['opened'] = false;
 ...
 * @default false
 */
RestEWebhook.prototype['contactCreated'] = false;
