...
/**
 * The RestRList model module.
 * @module sendx/model/RestRList
 * @version 1.0.0
 */
class RestRList {
    /**
     * Constructs a new <code>RestRList</code>.
     * @alias module:sendx/model/RestRList
     */
    constructor() { 
        
        RestRList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RestRList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestRList} obj Optional instance to populate.
     * @return {module:sendx/model/RestRList} The populated <code>RestRList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestRList();
    ...
    /**
     * Validates the JSON data with respect to <code>RestRList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestRList</code>.
     */
...
/**
     * Returns List type.  **Values:** - `0` - Regular list (single opt-in) - `1` - Double opt-in list (requires email confirmation) 
     * @return {module:sendx/model/RestRList.TypeEnum}
     */
    getType() {
        return this.type;
    }
    ...
    /**
     * Sets List type.  **Values:** - `0` - Regular list (single opt-in) - `1` - Double opt-in list (requires email confirmation) 
     * @param {module:sendx/model/RestRList.TypeEnum} type List type.  **Values:** - `0` - Regular list (single opt-in) - `1` - Double opt-in list (requires email confirmation) 
     */
    setType(type) {
        this['type'] = type;
    }
 ...
 * @member {String} id
 */
RestRList.prototype['id'] = undefined;

/**
 * @member {String} name
 */
RestRList.prototype['name'] = undefined;

/**
 * List type.  **Values:** - `0` - Regular list (single opt-in) - `1` - Double opt-in list (requires email confirmation) 
 * @member {module:sendx/model/RestRList.TypeEnum} type
 */
RestRList.prototype['type'] = undefined;

/**
 * @member {Date} created
 */
RestRList.prototype['created'] = undefined;

/**
 * @member {Date} updated
 */
RestRList.prototype['updated'] = undefined;
