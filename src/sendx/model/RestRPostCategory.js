...
/**
 * The RestRPostCategory model module.
 * @module sendx/model/RestRPostCategory
 * @version 1.0.0
 */
class RestRPostCategory {
    /**
     * Constructs a new <code>RestRPostCategory</code>.
     * @alias module:sendx/model/RestRPostCategory
     */
    constructor() { 
        
        RestRPostCategory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RestRPostCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestRPostCategory} obj Optional instance to populate.
     * @return {module:sendx/model/RestRPostCategory} The populated <code>RestRPostCategory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestRPostCategory();
    ...
    /**
     * Validates the JSON data with respect to <code>RestRPostCategory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestRPostCategory</code>.
     */
...
/**
     * Returns Id for the post category
     * @return {String}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Id for the post category
     * @param {String} id Id for the post category
     */
    setId(id) {
        this['id'] = id;
    }
/**
     * Returns Name for the post category
     * @return {String}
     */
    getName() {
        return this.name;
    ...
    /**
     * Sets Name for the post category
     * @param {String} name Name for the post category
     */
    setName(name) {
        this['name'] = name;
    }
/**
     * Returns Date and time when the post category was created
     * @return {Date}
     */
    getCreated() {
        return this.created;
    ...
    /**
     * Sets Date and time when the post category was created
     * @param {Date} created Date and time when the post category was created
     */
    setCreated(created) {
        this['created'] = created;
    }
/**
     * Returns Date and time when the post category was last updated
     * @return {Date}
     */
    getUpdated() {
        return this.updated;
    ...
    /**
     * Sets Date and time when the post category was last updated
     * @param {Date} updated Date and time when the post category was last updated
     */
    setUpdated(updated) {
 ...
 * @member {String} id
 */
RestRPostCategory.prototype['id'] = undefined;

/**
 * Name for the post category
 * @member {String} name
 */
RestRPostCategory.prototype['name'] = undefined;

/**
 * Date and time when the post category was created
 * @member {Date} created
 */
RestRPostCategory.prototype['created'] = undefined;

/**
 * Date and time when the post category was last updated
 * @member {Date} updated
 */
RestRPostCategory.prototype['updated'] = undefined;
...
export default RestRPostCategory;
