...
/**
 * The RestRSender model module.
 * @module sendx/model/RestRSender
 * @version 1.0.0
 */
class RestRSender {
    /**
     * Constructs a new <code>RestRSender</code>.
     * @alias module:sendx/model/RestRSender
     */
    constructor() { 
        
        RestRSender.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RestRSender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestRSender} obj Optional instance to populate.
     * @return {module:sendx/model/RestRSender} The populated <code>RestRSender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestRSender();
    ...
    /**
     * Validates the JSON data with respect to <code>RestRSender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestRSender</code>.
     */
...
/**
     * Returns Unique sender identifier with sender_ prefix
     * @return {String}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Unique sender identifier with sender_ prefix
     * @param {String} id Unique sender identifier with sender_ prefix
     */
    setId(id) {
        this['id'] = id;
    }
...
/**
     * Returns Sender whitelist status
     * @return {Boolean}
     */
    getIsWhitelisted() {
    ...
    /**
     * Sets Sender whitelist status
     * @param {Boolean} isWhitelisted Sender whitelist status
     */
 ...
 * @member {String} id
 */
RestRSender.prototype['id'] = undefined;

/**
 * Sender display name
 * @member {String} name
 */
RestRSender.prototype['name'] = undefined;

/**
 * Sender email address
 * @member {String} email
 */
RestRSender.prototype['email'] = undefined;

/**
 * Sender whitelist status
 * @member {Boolean} isWhitelisted
 */
RestRSender.prototype['isWhitelisted'] = undefined;
