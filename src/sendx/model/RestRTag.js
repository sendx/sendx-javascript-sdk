...
/**
 * The RestRTag model module.
 * @module sendx/model/RestRTag
 * @version 1.0.0
 */
class RestRTag {
    /**
     * Constructs a new <code>RestRTag</code>.
     * @alias module:sendx/model/RestRTag
     */
    constructor() { 
        
        RestRTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RestRTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/RestRTag} obj Optional instance to populate.
     * @return {module:sendx/model/RestRTag} The populated <code>RestRTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestRTag();
    ...
    /**
     * Validates the JSON data with respect to <code>RestRTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestRTag</code>.
     */
...
/**
     * Returns Unique tag identifier with tag_ prefix
     * @return {String}
     */
    getId() {
        return this.id;
    ...
    /**
     * Sets Unique tag identifier with tag_ prefix
     * @param {String} id Unique tag identifier with tag_ prefix
     */
    setId(id) {
        this['id'] = id;
    }
...
/**
     * Returns Tag creation timestamp
     * @return {Date}
     */
    getCreated() {
        return this.created;
    ...
    /**
     * Sets Tag creation timestamp
     * @param {Date} created Tag creation timestamp
     */
    setCreated(created) {
        this['created'] = created;
    }
/**
     * Returns Tag last update timestamp
     * @return {Date}
     */
    getUpdated() {
        return this.updated;
    ...
    /**
     * Sets Tag last update timestamp
     * @param {Date} updated Tag last update timestamp
     */
    setUpdated(updated) {
 ...
 * @member {String} id
 */
RestRTag.prototype['id'] = undefined;

/**
 * Tag name
 * @member {String} name
 */
RestRTag.prototype['name'] = undefined;

/**
 * Tag creation timestamp
 * @member {Date} created
 */
RestRTag.prototype['created'] = undefined;

/**
 * Tag last update timestamp
 * @member {Date} updated
 */
RestRTag.prototype['updated'] = undefined;
