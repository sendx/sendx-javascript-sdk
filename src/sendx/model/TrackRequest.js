...
/**
     * Returns Tags to add to contact
     * @return {Array.<String>}
     */
    getAddTags() {
        return this.addTags;
    ...
    /**
     * Sets Tags to add to contact
     * @param {Array.<String>} addTags Tags to add to contact
     */
    setAddTags(addTags) {
        this['addTags'] = addTags;
    }
/**
     * Returns Tags to remove from contact
     * @return {Array.<String>}
     */
    getRemoveTags() {
    ...
    /**
     * Sets Tags to remove from contact
     * @param {Array.<String>} removeTags Tags to remove from contact
     */
