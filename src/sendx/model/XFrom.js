...
/**
 * The XFrom model module.
 * @module sendx/model/XFrom
 * @version 1.0.0
 */
class XFrom {
    /**
     * Constructs a new <code>XFrom</code>.
     * @alias module:sendx/model/XFrom
     * @param email {String} 
     */
    constructor(email) { 
        
        XFrom.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>XFrom</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/XFrom} obj Optional instance to populate.
     * @return {module:sendx/model/XFrom} The populated <code>XFrom</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>XFrom</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XFrom</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of XFrom.RequiredProperties) {
...
XFrom.RequiredProperties = ["email"];

/**
 * @member {String} email
 */
XFrom.prototype['email'] = undefined;

/**
 * @member {String} name
 */
XFrom.prototype['name'] = undefined;
