...
/**
 * The XReplyTo model module.
 * @module sendx/model/XReplyTo
 * @version 1.0.0
 */
class XReplyTo {
    /**
     * Constructs a new <code>XReplyTo</code>.
     * @alias module:sendx/model/XReplyTo
     * @param email {String} 
     */
    constructor(email) { 
        
        XReplyTo.initialize(this, email);
    }
    ...
    /**
     * Constructs a <code>XReplyTo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sendx/model/XReplyTo} obj Optional instance to populate.
     * @return {module:sendx/model/XReplyTo} The populated <code>XReplyTo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XReplyTo();
    ...
    /**
     * Validates the JSON data with respect to <code>XReplyTo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XReplyTo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of XReplyTo.RequiredProperties) {
...
XReplyTo.RequiredProperties = ["email"];

/**
 * @member {String} email
 */
XReplyTo.prototype['email'] = undefined;

/**
 * @member {String} name
 */
XReplyTo.prototype['name'] = undefined;
