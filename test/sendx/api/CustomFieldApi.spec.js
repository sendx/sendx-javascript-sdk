...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.CustomFieldApi();
  });
  ...
  describe('CustomFieldApi', function() {
    ...
    describe('getAllCustomFields', function() {
      it('should call getAllCustomFields successfully', function(done) {
        //uncomment below and update the code to test getAllCustomFields
        //instance.getAllCustomFields(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
