...
(function(root, factory) {
  ...
  describe('EventsApi', function() {
    ...
    describe('trackRevenueEvent', function() {
      it('should call trackRevenueEvent successfully', function(done) {
        //uncomment below and update the code to test trackRevenueEvent
        //instance.trackRevenueEvent(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
