...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.PostCategoryApi();
  });
  ...
  describe('PostCategoryApi', function() {
    describe('createPostCategory', function() {
      it('should call createPostCategory successfully', function(done) {
        //uncomment below and update the code to test createPostCategory
        //instance.createPostCategory(function(error) {
    ...
    describe('deletePostCategory', function() {
      it('should call deletePostCategory successfully', function(done) {
        //uncomment below and update the code to test deletePostCategory
        //instance.deletePostCategory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllPostCategories', function() {
      it('should call getAllPostCategories successfully', function(done) {
        //uncomment below and update the code to test getAllPostCategories
        //instance.getAllPostCategories(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPostCategory', function() {
      it('should call getPostCategory successfully', function(done) {
        //uncomment below and update the code to test getPostCategory
        //instance.getPostCategory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updatePostCategory', function() {
      it('should call updatePostCategory successfully', function(done) {
        //uncomment below and update the code to test updatePostCategory
        //instance.updatePostCategory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
