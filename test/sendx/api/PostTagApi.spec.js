...
(function(root, factory) {
  ...
  describe('PostTagApi', function() {
    describe('createPostTag', function() {
      it('should call createPostTag successfully', function(done) {
        //uncomment below and update the code to test createPostTag
        //instance.createPostTag(function(error) {
    ...
    describe('deletePostTag', function() {
      it('should call deletePostTag successfully', function(done) {
        //uncomment below and update the code to test deletePostTag
        //instance.deletePostTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllPostTags', function() {
      it('should call getAllPostTags successfully', function(done) {
        //uncomment below and update the code to test getAllPostTags
        //instance.getAllPostTags(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPostTag', function() {
      it('should call getPostTag successfully', function(done) {
        //uncomment below and update the code to test getPostTag
        //instance.getPostTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updatePostTag', function() {
      it('should call updatePostTag successfully', function(done) {
        //uncomment below and update the code to test updatePostTag
        //instance.updatePostTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
