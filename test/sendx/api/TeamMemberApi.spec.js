...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.TeamMemberApi();
  });
  ...
  describe('TeamMemberApi', function() {
    describe('getAllTeamMembers', function() {
      it('should call getAllTeamMembers successfully', function(done) {
        //uncomment below and update the code to test getAllTeamMembers
        //instance.getAllTeamMembers(function(error) {
