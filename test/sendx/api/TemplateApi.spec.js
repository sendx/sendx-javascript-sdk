...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.TemplateApi();
  });
  ...
  describe('TemplateApi', function() {
    ...
    describe('getAllEmailTemplates', function() {
      it('should call getAllEmailTemplates successfully', function(done) {
        //uncomment below and update the code to test getAllEmailTemplates
        //instance.getAllEmailTemplates(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
