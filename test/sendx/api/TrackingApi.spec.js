...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.TrackingApi();
  });
  ...
  describe('TrackingApi', function() {
    ...
    describe('trackContact', function() {
      it('should call trackContact successfully', function(done) {
        //uncomment below and update the code to test trackContact
        //instance.trackContact(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
