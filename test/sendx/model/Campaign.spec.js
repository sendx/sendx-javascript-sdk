...
(function(root, factory) {
  ...
  describe('Campaign', function() {
    it('should create an instance of Campaign', function() {
      ...
      //var instance = new sendx.Campaign();
      //expect(instance).to.be.a(sendx.Campaign);
    });
    ...
    it('should have the property trackReply (base name: "trackReply")', function() {
      // uncomment below and update the code to test the property trackReply
      //var instance = new sendx.Campaign();
      //expect(instance).to.be();
    });
