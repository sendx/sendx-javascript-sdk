...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.EventsRevenuePostbackGet200Response();
  });
  ...
  describe('EventsRevenuePostbackGet200Response', function() {
    it('should create an instance of EventsRevenuePostbackGet200Response', function() {
      // uncomment below and update the code to test EventsRevenuePostbackGet200Response
      //var instance = new sendx.EventsRevenuePostbackGet200Response();
      //expect(instance).to.be.a(sendx.EventsRevenuePostbackGet200Response);
    });
