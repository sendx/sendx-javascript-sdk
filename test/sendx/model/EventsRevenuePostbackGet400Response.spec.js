...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.EventsRevenuePostbackGet400Response();
  });
  ...
  describe('EventsRevenuePostbackGet400Response', function() {
    it('should create an instance of EventsRevenuePostbackGet400Response', function() {
      // uncomment below and update the code to test EventsRevenuePostbackGet400Response
      //var instance = new sendx.EventsRevenuePostbackGet400Response();
      //expect(instance).to.be.a(sendx.EventsRevenuePostbackGet400Response);
    });
