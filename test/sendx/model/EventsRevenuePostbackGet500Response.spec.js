...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.EventsRevenuePostbackGet500Response();
  });
  ...
  describe('EventsRevenuePostbackGet500Response', function() {
    it('should create an instance of EventsRevenuePostbackGet500Response', function() {
      // uncomment below and update the code to test EventsRevenuePostbackGet500Response
      //var instance = new sendx.EventsRevenuePostbackGet500Response();
      //expect(instance).to.be.a(sendx.EventsRevenuePostbackGet500Response);
    });
