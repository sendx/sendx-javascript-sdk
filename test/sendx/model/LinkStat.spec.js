...
(function(root, factory) {
  ...
  describe('LinkStat', function() {
    it('should create an instance of LinkStat', function() {
      // uncomment below and update the code to test LinkStat
      //var instance = new sendx.LinkStat();
      //expect(instance).to.be.a(sendx.LinkStat);
    });
