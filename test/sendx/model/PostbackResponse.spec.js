...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.PostbackResponse();
  });
  ...
  describe('PostbackResponse', function() {
    it('should create an instance of PostbackResponse', function() {
      // uncomment below and update the code to test PostbackResponse
      //var instance = new sendx.PostbackResponse();
      //expect(instance).to.be.a(sendx.PostbackResponse);
    });
