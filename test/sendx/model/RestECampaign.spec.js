...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestECampaign();
  });
  ...
  describe('RestECampaign', function() {
    it('should create an instance of RestECampaign', function() {
      // uncomment below and update the code to test RestECampaign
      //var instance = new sendx.RestECampaign();
      //expect(instance).to.be.a(sendx.RestECampaign);
    });
