...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestEContact();
  });
  ...
  describe('RestEContact', function() {
    it('should create an instance of RestEContact', function() {
      // uncomment below and update the code to test RestEContact
      //var instance = new sendx.RestEContact();
      //expect(instance).to.be.a(sendx.RestEContact);
    });
