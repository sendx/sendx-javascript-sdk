...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestECustomField();
  });
  ...
  describe('RestECustomField', function() {
    it('should create an instance of RestECustomField', function() {
      // uncomment below and update the code to test RestECustomField
      //var instance = new sendx.RestECustomField();
      //expect(instance).to.be.a(sendx.RestECustomField);
    });
