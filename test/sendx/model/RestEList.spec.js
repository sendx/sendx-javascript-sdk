...
(function(root, factory) {
  ...
  describe('RestEList', function() {
    it('should create an instance of RestEList', function() {
      // uncomment below and update the code to test RestEList
      //var instance = new sendx.RestEList();
      //expect(instance).to.be.a(sendx.RestEList);
    });
