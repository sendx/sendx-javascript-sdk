...
(function(root, factory) {
  ...
  describe('RestEPost', function() {
    it('should create an instance of RestEPost', function() {
      // uncomment below and update the code to test RestEPost
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be.a(sendx.RestEPost);
    });
    ...
    it('should have the property postTitle (base name: "postTitle")', function() {
      // uncomment below and update the code to test the property postTitle
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property postDescription (base name: "postDescription")', function() {
      // uncomment below and update the code to test the property postDescription
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property postCategory (base name: "postCategory")', function() {
      // uncomment below and update the code to test the property postCategory
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });
    ...
    it('should have the property postThumbnail (base name: "postThumbnail")', function() {
      // uncomment below and update the code to test the property postThumbnail
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property postHtml (base name: "postHtml")', function() {
      // uncomment below and update the code to test the property postHtml
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property postTemplate (base name: "postTemplate")', function() {
      // uncomment below and update the code to test the property postTemplate
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });
    ...
    it('should have the property postSlug (base name: "postSlug")', function() {
      // uncomment below and update the code to test the property postSlug
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pageDescription (base name: "pageDescription")', function() {
      // uncomment below and update the code to test the property pageDescription
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property pageKeywords (base name: "pageKeywords")', function() {
      // uncomment below and update the code to test the property pageKeywords
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property socialTitle (base name: "socialTitle")', function() {
      // uncomment below and update the code to test the property socialTitle
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property socialDescription (base name: "socialDescription")', function() {
      // uncomment below and update the code to test the property socialDescription
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });

    it('should have the property socialImageUrl (base name: "socialImageUrl")', function() {
      // uncomment below and update the code to test the property socialImageUrl
      //var instance = new sendx.RestEPost();
      //expect(instance).to.be();
    });
