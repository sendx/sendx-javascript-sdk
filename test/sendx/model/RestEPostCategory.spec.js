...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestEPostCategory();
  });
  ...
  describe('RestEPostCategory', function() {
    it('should create an instance of RestEPostCategory', function() {
      // uncomment below and update the code to test RestEPostCategory
      //var instance = new sendx.RestEPostCategory();
      //expect(instance).to.be.a(sendx.RestEPostCategory);
    });
