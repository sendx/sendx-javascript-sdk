...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestEPostTag();
  });
  ...
  describe('RestEPostTag', function() {
    it('should create an instance of RestEPostTag', function() {
      // uncomment below and update the code to test RestEPostTag
      //var instance = new sendx.RestEPostTag();
      //expect(instance).to.be.a(sendx.RestEPostTag);
    });
