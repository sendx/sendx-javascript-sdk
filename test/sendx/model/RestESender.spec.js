...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestESender();
  });
  ...
  describe('RestESender', function() {
    it('should create an instance of RestESender', function() {
      // uncomment below and update the code to test RestESender
      //var instance = new sendx.RestESender();
      //expect(instance).to.be.a(sendx.RestESender);
    });
