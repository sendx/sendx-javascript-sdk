...
(function(root, factory) {
  ...
  describe('RestETag', function() {
    it('should create an instance of RestETag', function() {
      // uncomment below and update the code to test RestETag
      //var instance = new sendx.RestETag();
      //expect(instance).to.be.a(sendx.RestETag);
    });
