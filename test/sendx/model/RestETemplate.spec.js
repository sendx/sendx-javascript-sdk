...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestETemplate();
  });
  ...
  describe('RestETemplate', function() {
    it('should create an instance of RestETemplate', function() {
      // uncomment below and update the code to test RestETemplate
      //var instance = new sendx.RestETemplate();
      //expect(instance).to.be.a(sendx.RestETemplate);
    });
