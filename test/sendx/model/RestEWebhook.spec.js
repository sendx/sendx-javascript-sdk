...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestEWebhook();
  });
  ...
  describe('RestEWebhook', function() {
    it('should create an instance of RestEWebhook', function() {
      // uncomment below and update the code to test RestEWebhook
      //var instance = new sendx.RestEWebhook();
      //expect(instance).to.be.a(sendx.RestEWebhook);
    });
