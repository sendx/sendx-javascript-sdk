...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRCampaign();
  });
  ...
  describe('RestRCampaign', function() {
    it('should create an instance of RestRCampaign', function() {
      // uncomment below and update the code to test RestRCampaign
      //var instance = new sendx.RestRCampaign();
      //expect(instance).to.be.a(sendx.RestRCampaign);
    });
