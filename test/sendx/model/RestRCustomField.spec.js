...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRCustomField();
  });
  ...
  describe('RestRCustomField', function() {
    it('should create an instance of RestRCustomField', function() {
      // uncomment below and update the code to test RestRCustomField
      //var instance = new sendx.RestRCustomField();
      //expect(instance).to.be.a(sendx.RestRCustomField);
    });
