...
(function(root, factory) {
  ...
  describe('RestRList', function() {
    it('should create an instance of RestRList', function() {
      // uncomment below and update the code to test RestRList
      //var instance = new sendx.RestRList();
      //expect(instance).to.be.a(sendx.RestRList);
    });
