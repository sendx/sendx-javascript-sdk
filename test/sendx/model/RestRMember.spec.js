...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRMember();
  });
  ...
  describe('RestRMember', function() {
    it('should create an instance of RestRMember', function() {
      // uncomment below and update the code to test RestRMember
      //var instance = new sendx.RestRMember();
      //expect(instance).to.be.a(sendx.RestRMember);
    });
