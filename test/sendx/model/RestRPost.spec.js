...
(function(root, factory) {
  ...
  describe('RestRPost', function() {
    it('should create an instance of RestRPost', function() {
      // uncomment below and update the code to test RestRPost
      //var instance = new sendx.RestRPost();
      //expect(instance).to.be.a(sendx.RestRPost);
    });
