...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRPostCategory();
  });
  ...
  describe('RestRPostCategory', function() {
    it('should create an instance of RestRPostCategory', function() {
      // uncomment below and update the code to test RestRPostCategory
      //var instance = new sendx.RestRPostCategory();
      //expect(instance).to.be.a(sendx.RestRPostCategory);
    });
