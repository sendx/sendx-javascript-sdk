...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRPostTag();
  });
  ...
  describe('RestRPostTag', function() {
    it('should create an instance of RestRPostTag', function() {
      // uncomment below and update the code to test RestRPostTag
      //var instance = new sendx.RestRPostTag();
      //expect(instance).to.be.a(sendx.RestRPostTag);
    });
