...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRSender();
  });
  ...
  describe('RestRSender', function() {
    it('should create an instance of RestRSender', function() {
      // uncomment below and update the code to test RestRSender
      //var instance = new sendx.RestRSender();
      //expect(instance).to.be.a(sendx.RestRSender);
    });
