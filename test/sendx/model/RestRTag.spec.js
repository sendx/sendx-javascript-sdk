...
(function(root, factory) {
  ...
  describe('RestRTag', function() {
    it('should create an instance of RestRTag', function() {
      // uncomment below and update the code to test RestRTag
      //var instance = new sendx.RestRTag();
      //expect(instance).to.be.a(sendx.RestRTag);
    });
