...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRTemplate();
  });
  ...
  describe('RestRTemplate', function() {
    it('should create an instance of RestRTemplate', function() {
      // uncomment below and update the code to test RestRTemplate
      //var instance = new sendx.RestRTemplate();
      //expect(instance).to.be.a(sendx.RestRTemplate);
    });
