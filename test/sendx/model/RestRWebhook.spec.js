...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestRWebhook();
  });
  ...
  describe('RestRWebhook', function() {
    it('should create an instance of RestRWebhook', function() {
      // uncomment below and update the code to test RestRWebhook
      //var instance = new sendx.RestRWebhook();
      //expect(instance).to.be.a(sendx.RestRWebhook);
    });
    ...
    it('should have the property markedSpam (base name: "markedSpam")', function() {
      // uncomment below and update the code to test the property markedSpam
      //var instance = new sendx.RestRWebhook();
      //expect(instance).to.be();
    });
    ...
    it('should have the property contactCreated (base name: "contactCreated")', function() {
      // uncomment below and update the code to test the property contactCreated
      //var instance = new sendx.RestRWebhook();
      //expect(instance).to.be();
    });
