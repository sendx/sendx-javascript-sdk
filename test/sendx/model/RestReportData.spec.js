...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.RestReportData();
  });
  ...
  describe('RestReportData', function() {
    it('should create an instance of RestReportData', function() {
      // uncomment below and update the code to test RestReportData
      //var instance = new sendx.RestReportData();
      //expect(instance).to.be.a(sendx.RestReportData);
    });
