...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.TemplateEmailMessage();
  });
  ...
  describe('TemplateEmailMessage', function() {
    it('should create an instance of TemplateEmailMessage', function() {
      // uncomment below and update the code to test TemplateEmailMessage
      //var instance = new sendx.TemplateEmailMessage();
      //expect(instance).to.be.a(sendx.TemplateEmailMessage);
    });
