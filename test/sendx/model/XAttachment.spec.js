...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.XAttachment();
  });
  ...
  describe('XAttachment', function() {
    it('should create an instance of XAttachment', function() {
      // uncomment below and update the code to test XAttachment
      //var instance = new sendx.XAttachment();
      //expect(instance).to.be.a(sendx.XAttachment);
    });
