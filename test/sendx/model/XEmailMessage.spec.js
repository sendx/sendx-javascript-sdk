...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.XEmailMessage();
  });
  ...
  describe('XEmailMessage', function() {
    it('should create an instance of XEmailMessage', function() {
      // uncomment below and update the code to test XEmailMessage
      //var instance = new sendx.XEmailMessage();
      //expect(instance).to.be.a(sendx.XEmailMessage);
    });
