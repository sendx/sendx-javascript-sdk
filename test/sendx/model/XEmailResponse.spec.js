...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new sendx.XEmailResponse();
  });
  ...
  describe('XEmailResponse', function() {
    it('should create an instance of XEmailResponse', function() {
      // uncomment below and update the code to test XEmailResponse
      //var instance = new sendx.XEmailResponse();
      //expect(instance).to.be.a(sendx.XEmailResponse);
    });
