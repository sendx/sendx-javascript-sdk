...
(function(root, factory) {
  ...
  describe('XFrom', function() {
    it('should create an instance of XFrom', function() {
      // uncomment below and update the code to test XFrom
      //var instance = new sendx.XFrom();
      //expect(instance).to.be.a(sendx.XFrom);
    });
