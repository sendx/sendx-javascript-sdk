...
(function(root, factory) {
  ...
  describe('XReplyTo', function() {
    it('should create an instance of XReplyTo', function() {
      // uncomment below and update the code to test XReplyTo
      //var instance = new sendx.XReplyTo();
      //expect(instance).to.be.a(sendx.XReplyTo);
    });
