...
(function(root, factory) {
  ...
  describe('XTo', function() {
    it('should create an instance of XTo', function() {
      // uncomment below and update the code to test XTo
      //var instance = new sendx.XTo();
      //expect(instance).to.be.a(sendx.XTo);
    });
